            ...
            <section className="sms-breadcrumb mb-20">
                <div className="container-fluid">
                    <div className="flex justify-between items-center">
                        <h1 className="text-2xl font-bold">Exam Report</h1>
                            ...
                            <table className="w-full border-collapse">
                                <thead>
                                    <tr>
                                        ...
                                        <th className="text-left p-2 border-b border-gray-200">Total Marks</th>
                                        <th className="text-left p-2 border-b border-gray-200">GPA</th>
                                        <th className="text-left p-2 border-b border-gray-200">Result</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
